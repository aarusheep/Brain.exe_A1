...
export const SAMPLE_LEADS: Lead[] = [
    ...
    {
        id: "5",
        companyName: "Pacific Tech",
        industry: "IT Hardware",
        location: "Singapore",
        country: "Singapore",
        contactName: "Li Wei",
        contactRole: "Sourcing Specialist",
        matchPercentage: 85,
        estimatedValue: "$300k - $600k",
        companySize: "50-200",
        email: "li.wei@pacifictech.sg",
        reasoning: "Interested in high-reliability components for server infrastructure expansion."
    },
    {
        id: "6",
        companyName: "Maple Woodworks",
        ...
        companySize: "10-50",
        email: "david@maplewood.ca",
        reasoning: "Seeking new hardware suppliers for automated furniture line."
    }
];
